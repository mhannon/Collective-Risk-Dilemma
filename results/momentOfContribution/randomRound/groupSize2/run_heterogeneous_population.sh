...
do
for lostenom1 in 0.8 # this is alpha in the paper #part of the endowment lost with each risk round between 0-1
do
...
do
#let tD1=$enom0\+$enom2;
for target in 0 2 3 #this is 1 except for fermi or step curve opt 0 2 and 3 # 2 3 originally
do

generatioMax=100000 #00#number of steps until the end of one simualtion #100000
